...
** xref:streaming:get-started.adoc[Streaming documentation]: Broker and Redpanda CLI
** xref:connect:get-started.adoc[Connect documentation]: Data pipelines and integration
* xref:cloud-data-platform:get-started.adoc[Cloud documentation]: Fully managed services
...
* xref:cloud-data-platform:get-started.adoc[Get started with Cloud]
...
* xref:connect:get-started.adoc[Connect documentation]
