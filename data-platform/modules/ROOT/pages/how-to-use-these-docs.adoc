...
[NOTE]
====
*What we collect and why.* When you sign in, we receive your verified email address and organization from Redpanda Cloud, which we use to attribute documentation usage to your organization. This may be shared with our customer systems and passed to our documentation search provider (Kapa) for usage attribution.
====
