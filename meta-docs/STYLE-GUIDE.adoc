...
- Don't use screen shots. If the product changes and the screen shot is out-of-date, it could lead to a failed configuration and poor user experience with Redpanda.
