...
- **{site-url}/current.md[Redpanda Streaming]:** Deploy and manage Redpanda in your environment for ultimate control, high performance, and fault tolerance with Kafka compatibility and advanced enterprise features like Tiered Storage.
...
- {site-url}/current/get-started/quickstarts.md[Get started]: Fast-track your journey with Redpanda Streaming by deploying a complete example in Docker.
...
- {site-url}/current/deploy.md[Redpanda Streaming]: Install and configure Redpanda and Redpanda Console in self-hosted environments, including production best practices. Choose from Linux (bare-metal) or Kubernetes deployment instructions.
...
- {site-url}/current/reference/rpk/rpk-commands.md[rpk documentation for Redpanda Streaming]
