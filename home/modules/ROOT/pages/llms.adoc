...
- {site-url}/current/console/config.md[Configure Redpanda Console]: Learn how to configure Redpanda Console for your needs.
...
- {site-url}/redpanda-labs/home/index.md[Redpanda labs]: Step-by-step guides, best practices, and innovative projects demonstrating how to use Redpanda for real-world applications.
