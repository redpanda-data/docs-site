...
[IMPORTANT]
====
*Endpoint migration:* The previous endpoint at `https://docs.redpanda.com/mcp` is deprecated and will be shut down in **February 2026**. If you're currently using the old endpoint, please update your configuration to use the new Kapa-hosted endpoint: `https://redpanda.mcp.kapa.ai`.
...
When you connect to the Redpanda MCP server for the first time, a Google sign-in window opens to complete an OAuth / OpenID Connect login.
