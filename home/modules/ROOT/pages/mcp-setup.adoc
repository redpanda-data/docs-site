...
* Some MCP clients may have issues with SSE streaming. If you experience connection problems, verify your client supports HTTP-based MCP servers with Server-Sent Events (SSE).
